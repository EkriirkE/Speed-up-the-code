...
0..49999 | ForEach-Object -ThrottleLimit $env:NUMBER_OF_PROCESSORS -Parallel {
	$w=$using:work
	...
	$t=$w.d.AddSeconds(-$_).ToString("yyyy-MM-dd HH:mm:ss")	#IDK what to speed up here
	$p=$w.pa[$x%4]
	$o=$x%20+101
	$b=$x%101+1000
	$s=$w.sa[$x%3]
